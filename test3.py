...
def tao_luoi(grid_size):
    ...
    for i in range(grid_size * grid_size):
        if grid_size == 3:
            nut = tk.Button(khung_tro_choi, text=" ", font="Helvetica 30", height=4, width=8,
...
nut_pvp_3x3 = tk.Button(khung_che_do, text="Player vs Player 3x3", font="Helvetica 25", command=lambda: chon_che_do("PvP 3x3"))
nut_pvp_3x3.pack(pady=20)
nut_pvb_3x3 = tk.Button(khung_che_do, text="Player vs Bot 3x3", font="Helvetica 25", command=lambda: chon_che_do("PvB 3x3"))
nut_pvb_3x3.pack(pady=20)
nut_pvp_10x10 = tk.Button(khung_che_do, text="Player vs Player 10x10", font="Helvetica 25", command=lambda: chon_che_do("PvP 10x10"))
nut_pvp_10x10.pack(pady=20)
